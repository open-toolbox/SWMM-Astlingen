The SWMM model of Astlingen benchmark network is provide here.
...
Before running these models, you only need to reload the four rain files and the backdrop picture cause they are using relative paths. You can refer to the 1-year rainfall times series for the four different rain guages with the names of:
